                      ...
                      echo "
                        <tr style='color:black ; font-size: 15px; font-family:Times'>
                          ...
                          <td>
                            ...
                            <a href='#edit_photo' data-toggle='modal' class='pull-right photo' data-id='".$row['partyId']."'><span class='fa fa-edit'></span></a>
                          </td>
                          ...
                          <td>".$row['dateCreated']."</td>
                           ...
                           <td> 
                          <button class='btn btn-success btn-sm edit btn-curve' style='background-color: #9CD095 ;color:black ; font-size: 12px; font-family:Times'  data-id='".$row['partyId']."' ><i class='fa fa-edit'></i> Edit</button>
                            <button class='btn btn-danger btn-sm delete btn-curve' style='background-color:#ff8e88 ;color:black ; font-size: 12px; font-family:Times' data-id='".$row['partyId']."'><i class='fa fa-trash'></i> Delete</button>
                        </td>
...
function getRow(id){
  $.ajax({
    ...
    success: function(response){
      $('.id').val(response.partyId);
      $('#edit_partyname').val(response.partyName);
      $('#edit_datecreated').val(response.dateCreated);
      $('#description').val(response.description2)      
