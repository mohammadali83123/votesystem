            ...
            <div class="modal-body">
              <form class="form-horizontal" method="POST" action="party_add.php" enctype="multipart/form-data">
                <div class="form-group">
                    <label for="firstname" class="col-sm-3 control-label">partyname</label>
                ...
                <div class="form-group">
                    <label for="platform" class="col-sm-3 control-label">Desc</label>

                    <div class="col-sm-9">
                      <textarea class="form-control" id="platform" name="desc" rows="7"></textarea>
                    </div>
                </div>
            </div>
            <div class="modal-footer">
            ...
            <div class="modal-body">
              <form class="form-horizontal" method="POST" action="party_edit.php">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-9">
                      <input type="text" class="form-control" id="edit_partyname" name="partyname" required>
                    </div>
                </div>
                <div class="form-group">
