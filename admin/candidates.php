            ...
            <div class="box-body">
              <table id="example1" class="table ">
                <thead>
                  <th class="hidden"></th>
                  <th>Party</th>
                  <th>Party Identification Symbol</th>
                  <th>Position</th>
                  <th>Photo</th>
                  <th>Firstname</th>
                  <th>Lastname</th>
                ...
                <tbody>
                  <?php
                    ...
                    while($row = $query->fetch_assoc()){
                      ...
                      $sql2="SELECT * FROM parties wHERE partyId=".$row['partyId']."";
                      $query2 = $conn->query($sql2);
                      $row2 = $query2->fetch_assoc();
                      $image2 = (!empty($row2['photo'])) ? '../images/'.$row2['photo'] : '../images/profile.jpg';
                    
                      echo "
                        <tr style='color:black ; font-size: 15px; font-family:Times'>
                          <td class='hidden'></td>
                          <td>".$row2['partyName']."</td>
                          <td>
