  	...
  	<div class="login-box-body" style="background-color:#a69f8b ;color:white ; font-size: 22px; font-family:Times" >
    	...
    	<form action="login.php" method="POST">
      		<div class="form-group has-feedback">
        		<input type="text" class="form-control" name="voter" placeholder="Voter Email" required>
            ...
            <span class="glyphicon glyphicon-lock form-control-feedback"></span>
      		...
      		<div class="row">
    			<div class="col-xs-4">
					...
					<button type="button" class="btn btn-primary btn-block btn-curve" style="background-color: #4682B4 ;color:black ; font-size: 12px; font-family:Times" onclick="redirectToRegistrationForm()"><i class="fa fa-sign-in"></i> Sign Up</button>
				</div>
      		</div>
    	</form>
  	</div>
...
<script>
  function redirectToRegistrationForm() {
    ...
    var voterEmail = document.getElementsByName('voter')[0].value;
    if (voterEmail.trim() === '') {
      window.location.href = 'voter_registration_form.php';
    } else {
      alert('Please leave Voter\'s ID field empty to sign up.');
    }
  }
</script>
